...
async function increaseStake(amount) {
	...
	try {
		await vybeTx("approve", [STAKE_ADDRESS, amount]);
...
async function displayVybeStakeBalance() {
	...
	document.getElementById("user-stake-balance").innerHTML = `Staked Balance: ${ vybeStakeBalance }`;
}

// async function displayUSDValue() {
// 	const vybeUSD = await getVYBEPriceUSD();
...
// }
//
// async function displayETHValue() {
// 	const vybeETH = await getVYBEPriceETH();
// 	const vybeBalance = await getVYBEBalance();
...
async function displayVybeNetworkStake() {
	...
	vybeStakeBalance = await formatValue(vybeStakeBalance);
	document.getElementById("vybe-network-stake").innerHTML = vybeStakeBalance;
}

// async function displayVybeNetworkStakeUSD() {
// 	const vybeUSD = await getVYBEPriceUSD();
// 	let vybeStakeBalance = await getTotalStakedVYBE();
// 	vybeStakeBalance = await formatUSD(vybeStakeBalance * vybeUSD);
// 	document.getElementById("vybe-network-stake-usd").innerHTML = `${ vybeStakeBalance } USD`;
// }

// async function displayVybeNetworkStakeETH() {
// 	const vybeETH = await getVYBEPriceETH();
// 	let vybeStakeBalance = await getTotalStakedVYBE();
// 	vybeStakeBalance = await formatValue(vybeStakeBalance * vybeETH);
//
// 	if (vybeStakeBalance == '') {
//
// 	}
//
// 	document.getElementById("vybe-network-stake-eth").innerHTML = `${ vybeStakeBalance } ETH`;
// }
...
async function refreshStats() {
	...
	// displayVybeNetworkStakeUSD();
	// displayVybeNetworkStakeETH();
}
